    ...
    constructor( web3 ){
        ...
        this.ROUTERS = {
            [ EnumContracts[EnumChainId.BSC].ROUTERS.PANCAKE.toLowerCase()  ] : {
                ...
                _factory: EnumContracts[EnumChainId.BSC].FACTORIES.PANCAKE.toLowerCase()
            },
            [ EnumContracts[EnumChainId.BSC].ROUTERS.MDEX.toLowerCase() ] : {
                _hexadem: '0x0d994d996174b05cfc7bed897dc1b20b4c458fc8d64fe98bc78b3c64a6b4d093',
                _factory:  EnumContracts[EnumChainId.BSC].FACTORIES.MDEX.toLowerCase()
            },
            [ EnumContracts[EnumChainId.BSC].ROUTERS.BISWAP.toLowerCase() ] : {
                _hexadem: '0xfea293c909d87cd4153593f077b76bb7e94340200f4ee84211ae8e4f9bd7ffdf',
                _factory:  EnumContracts[EnumChainId.BSC].FACTORIES.BISWAP.toLowerCase()
            },
            [ EnumContracts[EnumChainId.BSC].ROUTERS.BABYSWAP.toLowerCase() ] : {
                _hexadem: '0x48c8bec5512d397a5d512fbb7d83d515e7b6d91e9838730bd1aa1b16575da7f5',
                _factory:  EnumContracts[EnumChainId.BSC].FACTORIES.BABYSWAP.toLowerCase()
            },
            [ EnumContracts[EnumChainId.BSC].ROUTERS.BABYSWAP.toLowerCase() ] : {
                _hexadem: '0x48c8bec5512d397a5d512fbb7d83d515e7b6d91e9838730bd1aa1b16575da7f5',
                _factory:  EnumContracts[EnumChainId.BSC].FACTORIES.BABYSWAP.toLowerCase()
            },
            [ EnumContracts[EnumChainId.BSC].ROUTERS.APESWAP.toLowerCase() ] : {
                _hexadem: '0xf4ccce374816856d11f00e4069e7cada164065686fbef53c6167a63ec2fd8c5b',
                _factory:  EnumContracts[EnumChainId.BSC].FACTORIES.APESWAP.toLowerCase()
            },
            [ EnumContracts[EnumChainId.BSC].ROUTERS.AUTOSHARK.toLowerCase() ] : {
                _hexadem: '0x024c8482358faf5eeea4ff7f0a18734bc482bf2e61ec04711fcee726756287ee',
                _factory:  EnumContracts[EnumChainId.BSC].FACTORIES.AUTOSHARK.toLowerCase()
            },
            [ EnumContracts[EnumChainId.BSC].ROUTERS.DEFINIX.toLowerCase() ] : {
                _hexadem: '0x898b8e59fbd4e8d6538b7d59d469440d56e24a77616ec248916ca9b36712dfe2',
                _factory:  EnumContracts[EnumChainId.BSC].FACTORIES.DEFINIX.toLowerCase()
            },
            [ EnumContracts[EnumChainId.BSC].ROUTERS.SUSHISWAP.toLowerCase() ] : {
                _hexadem: '0xe18a34eb0e04b04f7a0ac29a6e80748dca96319b42c54d679cb821dca90c6303',
                _factory:  EnumContracts[EnumChainId.BSC].FACTORIES.SUSHISWAP.toLowerCase()
            }
        }
    }
